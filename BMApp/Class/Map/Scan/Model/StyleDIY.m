...
+ (LBXScanViewStyle*)qqStyle
{
    ...
    style.colorRetangleLine = [UIColor getUsualColorWithString:@"#4285F4"];
    style.colorAngle = [UIColor getUsualColorWithString:@"#4285F4"];
    //扫码框周围4个角绘制的线条宽度
    ...
    //线条上下移动图片
    style.animationImage = [UIImage imageNamed:@"sao_tengtiao"];
