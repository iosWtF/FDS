...
@interface BMGroupInfoHeaderView()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@end
@implementation BMGroupInfoHeaderView

- (void)checkAll{
    
    NSInteger row = (self.sourceArr.count) / 5 ;
    if ((self.sourceArr.count) % 5 != 0) {
...
- (void)setSourceArr:(NSMutableArray *)sourceArr{
    ...
    if (sourceArr.count < 10 || sourceArr.count == 10) {
