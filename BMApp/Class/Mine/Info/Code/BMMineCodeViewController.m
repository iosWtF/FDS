...
@interface BMMineCodeViewController ()

@property(nonatomic ,strong)UIImage * img;

@end

@implementation BMMineCodeViewController
...
- (void)viewDidLoad {
    ...
    self.img = [self generateQRCodeWithString:[NSString stringWithFormat:@"cy:%@",UserID] Size:193 * AutoSizeScaleX];
