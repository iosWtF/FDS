...
@implementation BMOpinionCollectionViewCell
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        ZViewBorderRadius(_imageView, 3, 0, [UIColor whiteColor]);
        ...
        [_deleteBtn setImage:[UIImage imageNamed:@"fankui_icon_guanbi"] forState:UIControlStateNormal];
        _deleteBtn.imageEdgeInsets = UIEdgeInsetsMake(-8, 0, 0, -8);
...
- (void)layoutSubviews {
    ...
    _imageView.frame = CGRectMake(15, 15, Z_SCREEN_WIDTH / 3 - 30, Z_SCREEN_WIDTH / 3 - 30);
    _gifLable.frame = CGRectMake(self.tz_width - 25, self.tz_height - 14, 25, 14);
    _deleteBtn.frame = CGRectMake(self.tz_width - 39, 3, 36, 36);
