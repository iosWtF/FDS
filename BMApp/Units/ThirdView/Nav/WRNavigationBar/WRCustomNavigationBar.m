...
-(void)updateFrame {
    NSInteger top = SafeAreaTopStatusHeight;
    NSInteger margin = 15 * AutoSizeScaleX;
    NSInteger buttonHeight = 44 * AutoSizeScaleX;
    NSInteger buttonWidth = 60 * AutoSizeScaleX;
    NSInteger titleLabelHeight = 44 * AutoSizeScaleX;
    NSInteger titleLabelWidth = 180 * AutoSizeScaleX;
...
-(UIButton *)rightButton {
    if (!_rightButton) {
        ...
        _rightButton.titleLabel.font = [UIFont systemFontOfSize:14.f];
