...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return CGSizeMake(frame.size.width + _tagAttribute.tagSpace + 10, layout.itemSize.height);
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.selectedTags containsObject:self.tags[indexPath.item]]) {
        ...
        cell.titleLabel.textColor = _tagAttribute.selectColor;
...
- (NSMutableArray *)selectedTags
{
    if (!_selectedTags) {
        ...
        [_selectedTags addObject:_tags[0]];
    }
